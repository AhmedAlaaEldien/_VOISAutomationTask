...
public class WebDriverFactory {
     ...
     * @return Chrome webDriver or Firefox or Edge webDriver or null if no valid browser in the config file.
     */
    ...
    /**
     * Generate the Edge webDriver with registering WebDriverEventListener
     * @return Edge webDriver with headless option if it "True" in the browser config file.
     */
    private static WebDriver getEdgeDriver() {
        ...
        if (Boolean.parseBoolean(browserProps.getProperty("headless"))) {
            ...
            MyLogger.info(WebDriverFactory.class.getSimpleName(), "Initializing normal Edge driver");
